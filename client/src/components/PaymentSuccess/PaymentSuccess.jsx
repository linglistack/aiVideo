      ...
      try {
        ...
        if (sessionId) {
          ...
          if (profileResult.success) {
            ...
            const updatedUser = {
              ...currentUser,
              subscription: profileResult.user.subscription
            };
            localStorage.setItem('user', JSON.stringify(updatedUser));
            
            // Force a page reload to ensure all components see the updated user data
            setTimeout(() => {
              window.location.reload();
            }, 3000); // 3 second delay before redirect to ensure user sees success
          }
        } else {
